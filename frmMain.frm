...
Begin VB.MDIForm frmMain 
   ...
   Begin VB.Menu mnuTools 
      ...
      Begin VB.Menu mnuVSC 
         ...
         Visible         =   0   'False
      End
      Begin VB.Menu mnuVHIS 
         Caption         =   "&History"
      End
      Begin VB.Menu mnuBGCOL 
...
MsgBox "IMDB Data tool" & vbCrLf & vbCrLf & "Programmed by TecCRC" & vbCrLf & "Icons by Stock Sources" & vbCrLf & vbCrLf & "A tool to download movie information" & vbCrLf & _
                                                                                                                           ...
                                                                                                                           "display it in this nice little interface" & vbCrLf & vbCrLf & _
                                                                                                                           "Codes Version: " & CV & vbCrLf & "App Version: " & CODES_VER, vbInformation, "About IMDB Tool"
End Sub

Private Sub mnuBGCOL_Click()
Dim DDD() As String

Dim dd As String
dd = InputBox("Enter an RGB Value: EX: 000,000,000", "Change", "100,150,120")
If dd <> "" Then
    DDD = Split(dd, ",")
    BG_COL = RGB(DDD(0), DDD(1), DDD(2))
End If
